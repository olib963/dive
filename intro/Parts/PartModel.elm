module Parts.PartModel exposing (frames, world)
...
border_ =
    { defaultLine
      -- TODO thickness used to be width. API should be consistent!
        | thickness = 0.01

        -- TODO fill used to be color. API should be consistent!
        , fill = Collage.uniform black
    }
